...
#define DEVICE_NAME                      "Aneetta" 					                        /**< Name of device. Will be included in the advertising data. */
...
{
		//int32_t temperature;
		//printf("Entered timer_timeout_handler\n\r");
...
static void ble_stack_init(void)
{
    ...
    CHECK_RAM_START_ADDR(CENTRAL_LINK_COUNT,PERIPHERAL_LINK_COUNT);
		...
		// Set vendor specific count to 2, as two base ids are required for mobile app
		// - one for service and another for characteristic
...
{   
    ...
    bool erase_bonds;
		...
		uart_config();
		const char* str = "\r\n Radiius FW Ver : "FW_VER"\r\n";
    const char* timeStamp = " Build : " __DATE__ " " __TIME__ "\r\n";
    printf("\r\n##############################\r\n");
    printf(str);
    printf(timeStamp);
    printf("\r\n##############################\r\n");
